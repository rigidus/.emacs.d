...
;; Maintainer: David K�hling <dvdkhlng@gmx.de>
...
; W�rter ordentlich hilighten, die nicht auf Whitespace beginnen ( ..)IF
; -- mit aktueller Konzeption nicht m�glich??
;
; Konfiguration �ber customization groups
;
...
;
; Byte-compile-Code rausschmei�en, Compilieren im Makefile �ber Emacs
; batch-Modus
;
; forth-help Kram rausschmei�en
;
; XEmacs Kompatibilit�t? imenu/speedbar -> fume?
;
