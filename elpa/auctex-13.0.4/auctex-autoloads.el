...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tex" '("TeX-" "ispell-tex-major-modes" "Bib" "docTeX-default-extension" "LaTeX-" "plain-TeX-auto-regexp-list" "VirTeX-common-initialization" "tex-" "ConTeXt-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tex-buf" '("TeX-" "LaTeX-")))
