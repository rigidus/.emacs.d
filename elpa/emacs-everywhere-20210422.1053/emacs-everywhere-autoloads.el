;;; emacs-everywhere-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "emacs-everywhere" '("emacs-everywhere-")))
